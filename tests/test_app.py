    ...
    with TestClient(app) as client:
        ...
        created = client.post(
            ...
            data={
                ...
                "title": "Durable margin expansion",
                "statement": "Management expects margin expansion.",
                "status_value": "open",
                "confidence": "65",
                "owner": "Research",
...
def test_json_api_claims(tmp_path, monkeypatch):
    ...
    with TestClient(app) as client:
        payload = {
            "company": "Northstar",
            "title": "Demand remains resilient",
            "statement": "Demand remains resilient through the next quarter.",
            "status": "supported",
            "confidence": 80,
            "owner": "Strategy",
        }
